                ...
                <form method="POST" action="{{ route('admin.aulas.update', $aula) }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('codigo_aula') is-invalid @enderror" 
                                       id="codigo_aula" name="codigo_aula" value="{{ old('codigo_aula', $aula->codigo_aula) }}" 
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('tipo_aula') is-invalid @enderror" 
                                    ...
                                    <option value="aula" {{ old('tipo_aula', $aula->tipo_aula) == 'aula' ? 'selected' : '' }}>Aula Regular</option>
                                    ...
                                    <option value="sala_conferencias" {{ old('tipo_aula', $aula->tipo_aula) == 'sala_conferencias' ? 'selected' : '' }}>Sala de Conferencias</option>
                                    <option value="biblioteca" {{ old('tipo_aula', $aula->tipo_aula) == 'biblioteca' ? 'selected' : '' }}>Biblioteca</option>
                                </select>
                                @error('tipo_aula')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('edificio') is-invalid @enderror" 
                                       id="edificio" name="edificio" value="{{ old('edificio', $aula->edificio) }}" 
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('piso') is-invalid @enderror" 
                                       id="piso" name="piso" value="{{ old('piso', $aula->piso) }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                  ...
                                  placeholder="Descripción adicional del aula, equipamiento, etc.">{{ old('descripcion', $aula->descripcion) }}</textarea>
                        @error('descripcion')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('estado') is-invalid @enderror" 
                            ...
                            <option value="fuera_servicio" {{ old('estado', $aula->estado) == 'fuera_servicio' ? 'selected' : '' }}>Fuera de Servicio</option>
                        </select>
                        @error('estado')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="tiene_proyector" 
                                       name="tiene_proyector" value="1" {{ old('tiene_proyector', $aula->tiene_proyector) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="tiene_computadoras" 
                                       name="tiene_computadoras" value="1" {{ old('tiene_computadoras', $aula->tiene_computadoras) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="tiene_aire_acondicionado" 
                                       name="tiene_aire_acondicionado" value="1" {{ old('tiene_aire_acondicionado', $aula->tiene_aire_acondicionado) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="acceso_discapacitados" 
                                       name="acceso_discapacitados" value="1" {{ old('acceso_discapacitados', $aula->acceso_discapacitados) ? 'checked' : '' }}>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    <strong>Datos del Aula:</strong>
                    <ul class="mb-0 mt-2">
                        <li><strong>ID:</strong> {{ $aula->id }}</li>
                        <li><strong>Creada:</strong> {{ $aula->created_at->format('d/m/Y H:i') }}</li>
                        <li><strong>Actualizada:</strong> {{ $aula->updated_at->format('d/m/Y H:i') }}</li>
                    </ul>
                </div>
                ...
                <div class="alert alert-warning">
                    ...
                    Los cambios afectarán los horarios asignados a esta aula.
                </div>
            </div>
        </div>
    </div>
