        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold text-primary">Datos del Nuevo Docente</h6>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.docentes.store') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="codigo_docente" 
                                       name="codigo_docente" 
                                       value="{{ old('codigo_docente') }}"
                                       placeholder="Ej: PROF003"
                                       required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('tipo_contrato') is-invalid @enderror" 
                                    ...
                                    <option value="tiempo_completo" {{ old('tipo_contrato') == 'tiempo_completo' ? 'selected' : '' }}>
                                        Tiempo Completo
                                    </option>
                                    <option value="medio_tiempo" {{ old('tipo_contrato') == 'medio_tiempo' ? 'selected' : '' }}>
                                        Medio Tiempo
                                    </option>
                                    <option value="catedra" {{ old('tipo_contrato') == 'catedra' ? 'selected' : '' }}>
                                        Cátedra
                                    </option>
                                </select>
                                @error('tipo_contrato')
                        ...
                        <div class="mb-3">
                            <label for="password" class="form-label">
                                <i class="fas fa-lock"></i> Contraseña Inicial *
                            </label>
                            <input type="password" 
                            ...
                            @error('password')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Mínimo 6 caracteres. El docente podrá cambiarla después.</div>
                        </div>
