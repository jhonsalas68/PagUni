                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('creditos') is-invalid @enderror" 
                                   id="creditos" name="creditos" value="{{ old('creditos') }}" min="1" required>
                            @error('creditos')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('horas_teoricas') is-invalid @enderror" 
                                   id="horas_teoricas" name="horas_teoricas" value="{{ old('horas_teoricas') }}" min="0" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('horas_practicas') is-invalid @enderror" 
                                   id="horas_practicas" name="horas_practicas" value="{{ old('horas_practicas') }}" min="0" required>
